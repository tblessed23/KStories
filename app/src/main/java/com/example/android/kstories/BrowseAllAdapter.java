...
public class BrowseAllAdapter extends RecyclerView.Adapter<BrowseAllAdapter.BrowseViewHolder> {
     ...
     */
    @Override
    public BrowseAllAdapter.BrowseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // Inflate the task_layout to a view
        View view = LayoutInflater.from(mContext)
                .inflate(R.layout.browse_all_list, parent, false);

        return new BrowseAllAdapter.BrowseViewHolder(view);
    }
     ...
     */
    @Override
    public void onBindViewHolder(final BrowseAllAdapter.BrowseViewHolder holder, final int position) {
